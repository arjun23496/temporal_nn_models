...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--environment_config', default='environment_configs/task_medium.yaml',
                                 help='environment configuration file location.')
        ...
        self.parser.add_argument('--use_state',  default=True, action='store_true',
                                 help='Whether or not to give the state+action to the model')
